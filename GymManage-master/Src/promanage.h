...
public slots:
    ...
    void showCurrentvenueNo();//显示当前房间编号
    
private slots:

    void on_comboBoxvenueType_activated(const QString &arg1);//值改变时产生相应的动作
    void on_comboBoxvenuefloor_activated(const QString &arg1);

    void on_comboBoxvenueStatus_activated(const QString &arg1);
